...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen mt-14 bg-gradient-to-b from-[#0f0f13] to-[#18181b] py-12 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-6xl px-6 relative z-10">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center justify-center bg-[#232136]/80 backdrop-blur-md p-3 rounded-2xl shadow-xl shadow-purple-900/20 mb-4 border border-[#393552]"
          >
          ...
          <h1 className="text-4xl font-serif font-bold text-white mb-2">Get in Touch</h1>
          <motion.div
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1">
            <motion.div
              className="bg-[#1c1c24]/90 backdrop-blur-sm shadow-xl rounded-2xl overflow-hidden border border-[#2e2e3a]"
            ...
            >
              <div className="p-6 space-y-6">
                ...
                <div className="flex items-start">
                  <div className="h-10 w-10 rounded-lg bg-[#232136] flex items-center justify-center mr-4">
                    <FaMapMarkerAlt className="text-indigo-400" />
                  </div>
                  <div>
                    <h3 className="font-medium text-gray-300">Office Location</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@proofnest.com" className="text-indigo-400 hover:text-indigo-300 transition">
                      hello@proofnest.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+1-555-123-4567" className="text-indigo-400 hover:text-indigo-300 transition">
                      +1 (555) 123-4567
                    </a>
                  </div>
                </div>
                ...
                <div className="pt-6">
                  <h3 className="font-medium text-gray-300 mb-3">Operating Hours</h3>
              ...
              <div className="h-48 relative mt-4">
                <div className="absolute inset-0 bg-[#232136]/70 opacity-50"></div>
                <div className="absolute inset-0 flex items-center justify-center">
                  <p className="text-indigo-400 font-medium px-6 py-3 bg-[#18181b]/80 backdrop-blur-sm rounded-lg shadow-md border border-[#393552]">
          ...
          >
            <div className="bg-[#1c1c24]/90 backdrop-blur-sm shadow-xl rounded-2xl overflow-hidden border border-[#2e2e3a] p-8">
              ...
              {submitted ? (
                <motion.div
                  ...
                  className="bg-gradient-to-r from-green-900/30 to-emerald-900/30 p-6 rounded-xl border border-green-700/30 text-center"
                >
                  ...
                  <h3 className="text-xl font-bold text-gray-200 mb-2">Message Sent!</h3>
                  <p className="text-gray-400">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-3 rounded-lg bg-[#232136] border border-[#393552] text-white focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500 transition duration-200 placeholder-gray-500"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={6}
                      className="w-full px-4 py-3 rounded-lg bg-[#232136] border border-[#393552] text-white focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500 transition duration-200 resize-none placeholder-gray-500"
                  ...
                  <div className="flex justify-end">
                    <motion.button
                      type="submit"
                      className="px-8 py-4 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-xl font-medium text-lg shadow-lg shadow-purple-900/30 relative overflow-hidden group flex items-center"
                      whileHover={{
                        scale: 1.03,
